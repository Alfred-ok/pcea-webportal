...
import Districtdata from  "./Registration/Registration Form/Districtdata" //"./Registration/Registration Form/Districtdata";
  ...
  return (
    <CCard>
      ...
      <CForm onSubmit={handleSubmit}>
        <CRow>
            <CCol md={6}>
                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>*Full Name</CFormLabel> 
                <CFormInput placeholder="Enter Full Name" type="text" name="FullName" value={formData.FullName} onChange={handleChange} className="mb-3" required/>

                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>*Date of Birth</CFormLabel>
                <CFormInput type="date" name="DOB" value={formData.DOB} onChange={handleChange} className="mb-3" required/>
            </CCol>
            <CCol md={6}>
                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>*Gender</CFormLabel>
                <CFormSelect name="Gender" value={formData.Gender} onChange={handleChange} className="mb-3" required>
                ...
                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>*Holy Communion Status</CFormLabel>
                <CFormSelect name="HolyCommunionStatus" value={formData.HolyCommunionStatus} onChange={handleChange} className="mb-3" required>
        ...
        <CRow>
            <CCol md={6}>
                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>*Marital Status</CFormLabel>
                <CFormSelect name="MaritalStatus" value={formData.MaritalStatus} onChange={handleChange} className="mb-3" required>
                ...
                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>*Mobile Number</CFormLabel>
                <CFormInput placeholder="Enter Mobile Number i.e 07******" type="number" name="MobileNumber" value={formData.MobileNumber} className="mb-3" onChange={handleChange} required/>
            </CCol>
            <CCol md={6}>
              {/* 
                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>*National ID</CFormLabel>
                <CFormInput placeholder="Enter National ID" type="number" name="NationalID" value={formData.NationalID} className="mb-3" onChange={handleChange} required/>
                ...
                */}
                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>*ZP Number</CFormLabel>
                <CFormInput type="number" placeholder="Enter ZPNumber e.g 0123" name="ZPNumber" value={formData.ZPNumber} className="mb-3" onChange={handleChange} required/>
                
                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>*District</CFormLabel>
                    <CFormSelect name="District"  placeholder="Enter District" value={formData.District} onChange={handleChange} className="mb-3" required>
            ...
            <CCol md={6}>
                ...
                <>
                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>Spouse Name</CFormLabel>    
                <CFormInput type="text" name="SpouseName" placeholder="Enter Spouse Name" value={formData.SpouseName} className="mb-3" onChange={handleChange} />
                </>
                }
            </CCol>
            {formData.MaritalStatus != "Single" &&
            <CCol md={6}>
                <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>Spouse ZP Number</CFormLabel>
                <CFormInput type="number" placeholder="Enter ZPNumber e.g 0123" name="SpouseZPNumber" value={formData.SpouseZPNumber} className="mb-3" onChange={handleChange} />
            </CCol>
            }
        </CRow>
     ...
     <CRow>           
      ...
      <CRow>
      {
        /*
      <CCol md={6}>
      <CFormLabel style={{ fontWeight: "bold", color: "blue" }}>EPC Number</CFormLabel>
      <CFormInput placeholder="Enter ZPNumber e.g EP123" type="text" name="EPCNumber" value={formData.EPCNumber} className="mb-3" onChange={handleChange} />
      </CCol>
      */
      }
