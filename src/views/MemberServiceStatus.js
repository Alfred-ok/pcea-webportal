...
function MemberServiceStatus() {
  ...
  const exportPDF = async () => {
    ...
    try {
        ...
        doc.setFontSize(14);
        doc.text(
            "PCEA ZIMMERMAN SERVICE ATTENDANCE REPORT",
            pageWidth / 2,
...
*/
        ...
        doc.save("PCEA ZIMMERMAN SERVICE ATTENDANCE REPORT.pdf");
        setPdfLoading(false);
    } catch (error) {
    ...
    const fetchMemberStatus = async () => {
      ...
      try {
        ...
        const response = await fetch(
          //"http://197.232.170.121:8594/api/registrations/Getmemberhistoryservice",
          `${import.meta.env.VITE_BASE_URL}/Getmemberhistoryservice`,
          {
            method: "GET",
            headers: {
  ...
  const handleViewMore = async (member) => {
    ...
    try {
      ...
      const response = await fetch(
        //`http://197.232.170.121:8594/api/registrations/Memberservicehistory?zp=${zpnumber}`,
        `${import.meta.env.VITE_BASE_URL}/Memberservicehistory?zp=${member.zpnumber}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
...
export default MemberServiceStatus;
