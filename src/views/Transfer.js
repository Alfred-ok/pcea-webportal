    ...
    <>
      ...
      <CTabContent>
        <CTabPane visible={activeTab === 'rejoining'}>
          <Rejoining apiUrl={`${import.meta.env.VITE_BASE_URL}/getmembertansfer?status=0`}/*"http://197.232.170.121:8594/api/registrations/getmembertansfer?status=0"*/ activeTab={activeTab} />
        </CTabPane>
